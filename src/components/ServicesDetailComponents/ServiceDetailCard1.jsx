export default function ServiceDetailCard1({ img, service, title }) {
  return (
    <div className="sm:mt-48 mt-20 flex md:flex-row flex-col xl:w-[1140px] w-full sm:w-[540px] md:w-[720px] laptop:w-[960px]">
      <div
        className="flex md:w-[50%]  w-full gap-5 flex-col items-start justify-center"
        data-aos="fade-right"
      >
      ...
      <div className="md:w-[50%] w-full md:mt-1 mt-10 flex items-center justify-center" data-aos="fade-left">
